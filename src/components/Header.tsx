...
import { Search, Heart, ShoppingBag, User, Bell, Mic, Camera, Globe, Store } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 bg-glass border-b border-border">
      <div className="mx-auto max-w-[1400px] px-4 py-3 flex items-center gap-4">
        ...
        <nav className="flex items-center gap-1 text-xs">
          ...
          <Link to="/login" className="flex items-center gap-1 px-3 py-2 text-muted-foreground hover:text-foreground"><User size={16}/></Link>
